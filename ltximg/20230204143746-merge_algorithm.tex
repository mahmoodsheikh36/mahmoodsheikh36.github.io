...
\author{mahmood}
\date{\today}
\title{merge algorithm}
\hypersetup{
 pdfauthor={mahmood},
 pdftitle={merge algorithm},
 pdfkeywords={},
 pdfsubject={},
...
consider the \texttt{merge} algorithm that merges two partitions, i.e. takes in two sorted arrays A,B, and returns a new sorted array C that contains all elements from A and B\\[0pt]
\includesvg{/Users/mahmooz/brain/out/ONsc6RS}
\end{document}
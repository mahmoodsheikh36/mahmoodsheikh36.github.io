...
\author{mahmood}
\date{\today}
\title{practice algorithm questions}
\hypersetup{
 pdfauthor={mahmood},
 pdftitle={practice algorithm questions},
 pdfkeywords={},
 pdfsubject={},
...
\begin{question}
what does the following algorithm do? (|A|=N)\\
\begin{center}
\includesvg{/home/mahmooz/brain/out/VRN1HGB}
\end{center}
\begin{answer}
\begin{center}
\includesvg{/home/mahmooz/brain/out/6SkRO8V}
\end{center}
the \href{20221130014441-time_complexity.org}{time complexity} is \(\Theta(m+n)\) such that \(m = \textsc{Max}(A)\)\\
\end{answer}
\end{question}
\end{document}
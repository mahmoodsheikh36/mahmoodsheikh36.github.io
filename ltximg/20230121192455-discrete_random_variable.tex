...
\hypersetup{
 pdfauthor={mahmood},
 pdftitle={discrete random variable},
 pdfkeywords={},
 pdfsubject={},
...
\begin{definition}
a \href{20230104221353-random_variable.org}{random variable} is a \textbf{discrete random variable} iff it receives a finite or infinite \href{calculus2.org}{series} \(X_1,X_2,\dots\) of the values of the function \(P_x\) that is defined by \(P_x(X_i)=P(X=X_i)\) where \(i=1,2,\dots\) which is called the probability function of the random variable \(X\)\\[0pt]
\end{definition}
...
\end{characteristic}
\begin{note}
if \(X\) is a discrete random variable then the list of values that it could receive and their corresponding probabilities are called the \textbf{distribution law} or the \textbf{probability law} of said variable\\[0pt]
\end{note}
\end{document}
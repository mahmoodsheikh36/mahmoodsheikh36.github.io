...
but to make our hypothesis applicable to more [function space](20231124T204049--function-space__.org)s we extend this [linear function](20231222T080528--linear-map__math.org) with a set of <img src="/ltximg/bfb79e58d2f.svg" alt="\(M\)" style="height: 0.7680em; vertical-align: -0.0492em; display: inline-block" class="org-latex org-latex-inline" /> fixed, non-linear [basis function](20231122T194231--basis-function__.org)s <br/>
...
here, <img src="/ltximg/aa280bd2512.svg" alt="\(\brm{W}\)" style="height: 0.7704em; vertical-align: -0.0492em; display: inline-block" class="org-latex org-latex-inline" /> is the weight [matrix](20231222T075331--matrix__math.org) which we hope would represent a [linear transformation](20231222T080528--linear-map__math.org) that transforms a [vector](20231222T075237--vector__math.org) of input features <img src="/ltximg/651bd0091cf.svg" alt="\(\brm{x} \in \mathbb{R}^A\)" style="height: 0.9611em; vertical-align: -0.0875em; display: inline-block" class="org-latex org-latex-inline" /> into an output vector <img src="/ltximg/0ea87a04bfb.svg" alt="\(\brm{y} \in \mathbb{R}^K\)" style="height: 1.1133em; vertical-align: -0.2397em; display: inline-block" class="org-latex org-latex-inline" />. <br/>
(Christopher M. Bishop, 2006 section 3.1 linear basis function models) <br/>

</div>

we start with a random [point](20231016T171723--point__.org) in <img src="/ltximg/4dcec2a225c.svg" alt="\(\mathbb{R}^{K \times M}\)" style="height: 0.9228em; vertical-align: -0.0492em; display: inline-block" class="org-latex org-latex-inline" /> for <img src="/ltximg/aa280bd2512.svg" alt="\(\brm{W}\)" style="height: 0.7704em; vertical-align: -0.0492em; display: inline-block" class="org-latex org-latex-inline" />, and use an [optimization algorithm](20231120T195616--optimization-algorithm__cs.org) to arrive at a good enough approximation of a hypothetical target function <img src="/ltximg/a5ead3743e6.svg" alt="\(\brm{f}\)" style="height: 0.7704em; vertical-align: -0.0492em; display: inline-block" class="org-latex org-latex-inline" /> from which we assume the observations <img src="/ltximg/b2c3553378e.svg" alt="\(\{\brm{x}_j\}\)" style="height: 1.1138em; vertical-align: -0.3296em; display: inline-block" class="org-latex org-latex-inline" /> were drawn, "good enough" being defined by some criterion or [loss function](20231019T204317--loss-function__math.org). <br/>
here we consider the traditional [gradient descent](20230422T235640--gradient-descent__math.org) as the optimization method. the observations may potentially be divided into [batch](20231121T113929--batch__.org)es, but that doesnt matter in theory. our goal is to converge on a good enough <img src="/ltximg/aa280bd2512.svg" alt="\(\brm{W}\)" style="height: 0.7704em; vertical-align: -0.0492em; display: inline-block" class="org-latex org-latex-inline" /> by going in the direction opposite to that of the [gradient](20230505T230706--gradient__math.org) of the loss function, because by doing so we could get closer to a local minima point (i.e. "sliding downhill") so a _training step_ would consist of: <br/>
...
where <img src="/ltximg/7c012388408.svg" alt="\(L\)" style="height: 0.7680em; vertical-align: -0.0492em; display: inline-block" class="org-latex org-latex-inline" /> is the loss function and <img src="/ltximg/4c8a1baec4f.svg" alt="\(\eta\)" style="height: 0.7109em; vertical-align: -0.2397em; display: inline-block" class="org-latex org-latex-inline" /> is the [learning rate](20230423T002354--learning-rate__.org). <br/>

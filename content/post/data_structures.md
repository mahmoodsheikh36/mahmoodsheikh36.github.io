...
1.  simple rotation
    ...
    1.  left left rotation
        ...
        {{< figure src="/ox-hugo/leftleftrotation.gif" caption="<span class=\"figure-number\">Figure 1: </span>gif of left left rotation taken from <https://www.codesdope.com/course/data-structures-red-black-trees-insertion/>" >}} <br/>
        
        <div class="my_example">
        
        consider the following [AVL tree](#avl-tree): <br/>
        
        {{< figure src="/ox-hugo/OCEhdh.png" >}} <br/>
        
        after inserting a new [node](#node) with the value 2 this is how the tree would look: <br/>
        
        {{< figure src="/ox-hugo/nMREes.png" >}} <br/>
        ...
        {{< figure src="/ox-hugo/ZIzaCe.png" >}} <br/>
        
        the [subtree](#subtree) after the [rotation](#rotation): <br/>
        
        {{< figure src="/ox-hugo/diNERQ.png" >}} <br/>
        
        and so the original tree would become: <br/>
        
        {{< figure src="/ox-hugo/pBO906.png" >}} <br/>
    ...
    2.  right right rotation
        ...
        {{< figure src="/ox-hugo/rightrightrotation.gif" caption="<span class=\"figure-number\">Figure 2: </span>gif of right right rotation taken from <https://www.codesdope.com/course/data-structures-red-black-trees-insertion/>" >}} <br/>
...
{{< figure src="/ox-hugo/1G8WJzK.png" >}} <br/>
...
{{< figure src="/ox-hugo/2-3_insertion.jpg" caption="<span class=\"figure-number\">Figure 3: </span>2-3 insertion visual explanation <&opengenus_twothree_tree>" >}} <br/>
...
{{< figure src="/ox-hugo/FhrWMkp.png" >}} <br/>
...
{{< figure src="/ox-hugo/4Dxfezg.png" >}} <br/>

{{< figure src="/ox-hugo/zcbrzTz.png" >}} <br/>

{{< figure src="/ox-hugo/rU6zXpo.png" >}} <br/>

{{< figure src="/ox-hugo/HClZKCX.png" >}} <br/>
...
{{< figure src="/ox-hugo/tHkzZWu.png" >}} <br/>
...
{{< figure src="/ox-hugo/7kcwMR4.png" >}} <br/>
...
{{< figure src="/ox-hugo/mmqMhmW.png" >}} <br/>
...
{{< figure src="/ox-hugo/ejJXe51.png" >}} <br/>
...
{{< figure src="/ox-hugo/quicksort.png" caption="<span class=\"figure-number\">Figure 4: </span>quick sort such that the last element is picked as pivot, taken from <https://workat.tech/problem-solving/tutorial/sorting-algorithms-quick-sort-merge-sort-dsa-tutorials-6j3h98lk6j2w>" >}} <br/>
...
{{< figure src="/ox-hugo/merge_sort.webp" caption="<span class=\"figure-number\">Figure 5: </span>this image (which visualizes the process) was taken from <https://www.programiz.com/dsa/merge-sort>, will keep this here until i make my own" >}} <br/>

...
the [sum]({{< relref "20220711175813-sum.md" >}}) of a finite [geometric progression]({{< relref "20220711182226-geometric_progression.md" >}}) with initial term \\(a\\), common ratio \\(r\\) and \\(n\\) terms can be found using the [formula]({{< relref "20220711175314-formula.md" >}}): <br/>
\\[

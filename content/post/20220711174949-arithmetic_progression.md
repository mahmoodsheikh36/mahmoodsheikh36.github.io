...
An **arithmetic progression** or **arithmetic sequence** is a [sequence]({{< relref "20220711175112-sequence.md" >}}) of [numbers]({{< relref "calculus2.md#numbers" >}}) such that the difference between the consecutive terms is constant <br/>
if the first number of an arithmetic progression is \\(a\_{1}\\) and the difference of successive numbers is \\(d\\) then the [formula]({{< relref "20220711175314-formula.md" >}}) for the $n$th number in the sequence is: <br/>
\\[
  a\_{n} = a\_1 + (n-1)d
\\] <br/>
and the general formula is <br/>
\\[
  a\_{n} = a\_m + (n-m)d
\\] <br/>
where \\(a\_m\\) is a number in the sequence at index \\(m\\) <br/>
...
the [sum]({{< relref "20220711175813-sum.md" >}}) of the numbers in a finite [Arithmetic sequence]({{< relref "20220711174949-arithmetic_progression.md" >}}) is given by the following [formula]({{< relref "20220711175314-formula.md" >}}): <br/>
\\[
  S = \frac{n(a\_1 + a\_n)}{2}
\\] <br/>
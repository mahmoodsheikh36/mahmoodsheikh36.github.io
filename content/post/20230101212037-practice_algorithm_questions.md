+++
title = "practice algorithm questions"
author = ["mahmood"]
date = 2023-01-02T15:01:00+02:00
tags = ["math"]
draft = false
+++
...
what does the following algorithm do? (|A|=N) <br/>

{{< figure src="/ox-hugo/VRN1HGB.svg" >}} <br/>

<div class="answer">

![](/ox-hugo/6SkRO8V.svg) <br/>
the [time complexity]({{< relref "20221130014441-time_complexity.md" >}}) is \\(\Theta(m+n)\\) such that \\(m = \textsc{Max}(A)\\) <br/>

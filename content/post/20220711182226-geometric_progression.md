...
a geometric progression is a [sequence]({{< relref "20220711175112-sequence.md" >}}) of non-zero numbers where each term after the first is found by multiplying the previous one by a fixed, non-zero number called the **common ratio** <br/>
the [formula]({{< relref "20220711175314-formula.md" >}}) for the $n$th number in a geometric sequence with initial value \\(a\\) and common ratio \\(r\\) is: <br/>
\\[
  a\_{n}=ar^{n-1}
\\] <br/>
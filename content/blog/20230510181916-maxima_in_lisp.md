...
<b>maxima</b> is written in <b>lisp</b> and so it can be used as a modified/extended lisp runtime <br/>
...
can also run this in <b>emacs</b>' slime/sly with `(sly "rmaxima -r to_lisp();")` <br/>
